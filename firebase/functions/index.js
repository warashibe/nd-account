...
const conf = functions.config().env
...
exports.loginUport = functions.https.onRequest(async (req, res) => {
...
exports.loginMetamask = functions.https.onRequest(async (req, res) => {
...
exports.loginAuthereum = functions.https.onRequest(async (req, res) => {
  res.header("Access-Control-Allow-Origin", "*")
  res.header(
    "Access-Control-Allow-Headers",
    "Origin, X-Requested-With, Content-Type, Accept"
