...
var socials_map = _ramdam["default"].indexBy(_ramdam["default"].prop("key"))(_.socials);
...
var Component = function Component(props) {
  var methods = _ramdam["default"].isNil(props.methods) ? _.socials : _ramdam["default"].filter(function (v) {
    return _ramdam["default"].includes(v.key)(props.methods);
  })(_.socials);
  return /*#__PURE__*/React.createElement(_rebass.Flex, {
    textAlign: "center"
  }, /*#__PURE__*/React.createElement(_rebass.Box, {
    p: 3,
    width: 1
  }, /*#__PURE__*/React.createElement(_rebass.Flex, {
    width: 1,
    flexWrap: "wrap"
  }, _ramdam["default"].compose(_ramdam["default"].filter(_ramdam["default"].xNil), _ramdam["default"].map(function (v) {
    return _ramdam["default"].includes(v)(["authereum", "metamask"]) ? null : /*#__PURE__*/React.createElement(_rebass.Flex, {
    ...
    }, /*#__PURE__*/React.createElement(_rebass.Image, {
      src: "/static/account/images/".concat(socials_map[v].key, "-white.png"),
      height: ["50px"]
    }), /*#__PURE__*/React.createElement(_rebass.Text, {
      mt: 1
    }, /*#__PURE__*/React.createElement(_rebass.Box, {
      fontSize: "18px",
      fontWeight: "bold"
    }, socials_map[v].name), /*#__PURE__*/React.createElement(_rebass.Box, {
      as: "span",
      fontSize: "12px"
    }, "Unlink"))));
