...
var changeUser = [[].concat(_userUpdate_props), /*#__PURE__*/function () {
...
var login_with = {
  steem: function () {
    var _steem = (0, _asyncToGenerator2["default"])( /*#__PURE__*/_regenerator["default"].mark(function _callee9(_ref15) {
      var set, state$, _ref15$link, link, conf, _yield$p, _yield$p2, error, code, login_url;

      return _regenerator["default"].wrap(function _callee9$(_context9) {
        while (1) {
          switch (_context9.prev = _context9.next) {
            case 0:
              set = _ref15.set, state$ = _ref15.state$, _ref15$link = _ref15.link, link = _ref15$link === void 0 ? false : _ref15$link, conf = _ref15.conf;
              _context9.next = 3;
  ...
  authereum: function () {
    var _authereum = (0, _asyncToGenerator2["default"])( /*#__PURE__*/_regenerator["default"].mark(function _callee11(_ref17) {
      var conf, set, state$, provider, address, id, signature, login_url, res, auth, _yield$err5, _yield$err6, error, user, add, Box, box, profile;

      return _regenerator["default"].wrap(function _callee11$(_context11) {
        while (1) {
          switch (_context11.prev = _context11.next) {
            case 0:
              conf = _ref17.conf, set = _ref17.set, state$ = _ref17.state$;
  ...
  metamask: function () {
    var _metamask = (0, _asyncToGenerator2["default"])( /*#__PURE__*/_regenerator["default"].mark(function _callee12(_ref18) {
      var conf, set, state$, address, id, _yield$err7, _yield$err8, error, signature, login_url, res, auth, _yield$err9, _yield$err10, err2, user, add, Box, box, profile;

      return _regenerator["default"].wrap(function _callee12$(_context12) {
        while (1) {
          switch (_context12.prev = _context12.next) {
            case 0:
              conf = _ref18.conf, set = _ref18.set, state$ = _ref18.state$;
  ...
  uport: function () {
    var _uport = (0, _asyncToGenerator2["default"])( /*#__PURE__*/_regenerator["default"].mark(function _callee14(_ref19) {
      var conf, set, state$, _ref19$link, link, id, unsub, login_url, json;

      return _regenerator["default"].wrap(function _callee14$(_context14) {
        while (1) {
          switch (_context14.prev = _context14.next) {
            case 0:
              conf = _ref19.conf, set = _ref19.set, state$ = _ref19.state$, _ref19$link = _ref19.link, link = _ref19$link === void 0 ? false : _ref19$link;
              id = _shortid["default"].generate();
              _context14.next = 4;
...
var login = [["processing$util", "uport$account"], /*#__PURE__*/function () {
  var _ref22 = (0, _asyncToGenerator2["default"])( /*#__PURE__*/_regenerator["default"].mark(function _callee15(_ref21) {
    var provider, set, state$, conf, _provider, auth, _yield$err13, _yield$err14, error, user;

    return _regenerator["default"].wrap(function _callee15$(_context15) {
      while (1) {
        switch (_context15.prev = _context15.next) {
          case 0:
            provider = _ref21.val.provider, set = _ref21.set, state$ = _ref21.state$, conf = _ref21.conf;
...
var checkUser = /*#__PURE__*/function () {
  var _ref23 = (0, _asyncToGenerator2["default"])( /*#__PURE__*/_regenerator["default"].mark(function _callee17(state$) {
...
var check_alis = [["processing$util"], /*#__PURE__*/function () {
    ...
    return _regenerator["default"].wrap(function _callee18$(_context18) {
      while (1) {
        switch (_context18.prev = _context18.next) {
          case 0:
            router = _ref25.val.router, state$ = _ref25.state$, set = _ref25.set;
...
var _login_with = /*#__PURE__*/function () {
  var _ref28 = (0, _asyncToGenerator2["default"])( /*#__PURE__*/_regenerator["default"].mark(function _callee19(_ref27) {
    var set, state$, login_url, provider, res, auth, _yield$err15, _yield$err16, error, user;

    return _regenerator["default"].wrap(function _callee19$(_context19) {
      while (1) {
        switch (_context19.prev = _context19.next) {
          case 0:
            set = _ref27.set, state$ = _ref27.state$, login_url = _ref27.login_url, provider = _ref27.provider;

            if ((0, _ramda.hasPath)(["value", "user", "uid"])(state$)) {
...
var deleteAccount = [["processing$util"], /*#__PURE__*/function () {
...
var linkAccount = [["processing$util"], /*#__PURE__*/function () {
  var _ref34 = (0, _asyncToGenerator2["default"])( /*#__PURE__*/_regenerator["default"].mark(function _callee22(_ref33) {
    var _ref33$val, provider, user, set, state$, conf, _provider, currentUser, _yield$err17, _yield$err18, error, result;

    return _regenerator["default"].wrap(function _callee22$(_context22) {
      while (1) {
        switch (_context22.prev = _context22.next) {
          case 0:
            _ref33$val = _ref33.val, provider = _ref33$val.provider, user = _ref33$val.user, set = _ref33.set, state$ = _ref33.state$, conf = _ref33.conf;
            set(true, "processing$util");
...
var unlinkAccount = [["processing$util"], /*#__PURE__*/function () {
