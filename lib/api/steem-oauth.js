          ...
          switch (_context.prev = _context.next) {
            ...
            case 7:
              ...
              if (R.isNotNil(query.uid)) {
                href = "".concat(func_url, "?target=steem&uid=").concat(R.isArray(query.uid) ? query.uid[0] : query.uid, "&user_id=").concat(r2.id, "&token=").concat(query.code, "&refresh=&name=").concat(encodeURIComponent(r2.name || r2.id), "&img=").concat(encodeURIComponent(r2.profile_image));
              } else {
